...
def main(date):
    ...
    # Define the path where input files are located
    input_path = f"gs://airflow_projects_repo/airflow-project-2/data/orders_{date}.csv"
    ...
    output_path = f"gs://airflow_projects_repo/airflow-project-2/output/processed_orders_{date}"
